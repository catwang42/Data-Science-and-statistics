...
def run_softmax_on_MNIST(temp_parameter=1):
    ...
    test_error = compute_test_error_mod3(test_x, update_y(test_y), theta, temp_parameter)
...
temp_params = [0.5, 1, 2]
print('\nsoftmax test_error')
for temp_parameter in temp_params:
    softmax_text_error = run_softmax_on_MNIST
"""
#######################################################################
# 6. Changing Labels
#######################################################################
...
def run_softmax_on_MNIST_mod3(temp_parameter=1):
    ...
    # YOUR CODE HERE
    train_x, train_y, test_x, test_y = get_MNIST_data()
    theta, cost_function_history = softmax_regression(train_x, update_y(train_y), temp_parameter, alpha=0.3, lambda_factor=1.0e-4,
...
print('softmax mod test_error=', run_softmax_on_MNIST_mod3(temp_parameter=1))
...
def run_softmax_on_MNIST_pca(temp_parameter=1):
    """
    Trains Softmax regression on digit classifications using PCA feature.
...
print('softmax pca test_error=', run_softmax_on_MNIST_pca(temp_parameter=1))
...
print('softmax cube test_error=', run_softmax_on_MNIST_cube(temp_parameter=1))